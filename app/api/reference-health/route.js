...
async function brightDataHealth(key){
  ...
  return{configured:true,healthy:statusHealthy(statusText,statusInfo),httpStatus:status,error:null,zones,balance:balance.balance,pendingBalance:balance.pendingBalance,noCredits:false,statusInfo};
}
