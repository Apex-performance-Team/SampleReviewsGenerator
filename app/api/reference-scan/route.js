...
function manualAmazonReferenceSet(body,originalProductUrl){const raw=clean(body?.amazonListingUrl),asin=amazonAsinV2(raw);if(!raw)return null;if(!asin)throw Error('Known Amazon listing must contain a valid 10-character ASIN.');const sourceUrl=`https://www.amazon.com/dp/${asin}`,source={platform:'amazon.com',provider:'user_supplied_amazon_listing',sourceUrl,directSourceUrl:sourceUrl,asin,title:'User-supplied Amazon listing',status:'found',matchConfidence:1,confidence:'high',publicReviewCount:null,extractedReviewCount:0,individualExtractedCount:0,pageCount:1,aggregateOnly:true,ratingEstimate:null,error:null,linkVerified:true,linkVerification:'user_supplied_amazon_listing',lensTabs:['manual_amazon_listing'],lensRank:null,verificationMethod:'user_supplied_amazon_listing',verificationReason:'Amazon listing supplied directly for this product scan.',discoveryOrigin:'manual_verified_amazon'};return{version:'individual-reference-v12',provider:'user_supplied_amazon_listing',productUrl:originalProductUrl,productTitle:clean(body?.productTitle),productDescription:clean(body?.productDescription),references:[],pulledReferences:[],sourceCounts:[source],aggregateOnlySources:[],platformCounts:[],totalIndividualReviews:0,totalPulledReviews:0,availableForGeneration:0,confidence:'high',matchedPages:1,verifiedSourceLinks:1,lensDiscovery:{enabled:false,status:'skipped',reason:'user_supplied_amazon_listing'},provenance:{manualAmazonListing:true,originalProductUrl,amazonListingUrl:sourceUrl},syntheticUseOnly:true,sourceReviewTextExported:false}}
