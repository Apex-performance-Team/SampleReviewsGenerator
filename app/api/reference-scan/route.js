...
export async function POST(req){try{
  ...
  const discovery=await aiDiscover(req,{productTitle,productDescription,heroImage,sourceUrl:source.url}),sourceHost=host(source.url),map=new Map();
