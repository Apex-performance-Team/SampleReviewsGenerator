...
const MODES={
  ...
  balanced:{label:'Balanced',detail:'2 images · up to 6 Lens requests · 5 reference AI calls · 3 Amazon queries · 50 Amazon/eBay reviews'},
  thorough:{label:'Thorough',detail:'4 images · up to 12 Lens requests · 5 reference AI calls · 4 Amazon queries · 50 Amazon/eBay reviews'}
};
