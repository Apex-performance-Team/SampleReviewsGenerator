...
function usableOriginalLens(json,tab){if(!json||typeof json!=='object')return false;if(tab==='exact_matches')return Array.isArray(json.exact_matches);return lensResultCount(json,tab)>0||hasTabPayload(json,tab)}
