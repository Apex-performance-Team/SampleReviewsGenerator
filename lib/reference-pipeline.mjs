const BUDGETS={
  ...
  balanced:{id:'balanced',label:'Balanced',maxImages:3,maxCandidates:30,maxSources:20,maxPages:5,maxEndpoints:10,maxMarketplaceReviews:200,maxAmazonQueries:4,maxAmazonPages:2,maxReferenceAiCalls:8,useAiCountEnrichment:true,useAiAmazonQueries:true,useAiAmazonWebFallback:true},
  thorough:{id:'thorough',label:'Thorough',maxImages:4,maxCandidates:36,maxSources:24,maxPages:8,maxEndpoints:16,maxMarketplaceReviews:200,maxAmazonQueries:4,maxAmazonPages:2,maxReferenceAiCalls:10,useAiCountEnrichment:true,useAiAmazonQueries:true,useAiAmazonWebFallback:true}
};
