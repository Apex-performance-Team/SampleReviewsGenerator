const BUDGETS={
  test:{id:'test',label:'Test',maxImages:1,maxCandidates:12,maxSources:8,maxPages:3,maxEndpoints:6,maxMarketplaceReviews:20,maxAmazonQueries:1,maxAmazonPages:1,maxReferenceAiCalls:2,useAiCountEnrichment:false,useAiAmazonQueries:false,useAiAmazonWebFallback:false},
  balanced:{id:'balanced',label:'Balanced',maxImages:2,maxCandidates:24,maxSources:16,maxPages:5,maxEndpoints:10,maxMarketplaceReviews:50,maxAmazonQueries:3,maxAmazonPages:2,maxReferenceAiCalls:5,useAiCountEnrichment:true,useAiAmazonQueries:true,useAiAmazonWebFallback:true},
  thorough:{id:'thorough',label:'Thorough',maxImages:4,maxCandidates:36,maxSources:24,maxPages:8,maxEndpoints:16,maxMarketplaceReviews:50,maxAmazonQueries:4,maxAmazonPages:2,maxReferenceAiCalls:5,useAiCountEnrichment:true,useAiAmazonQueries:true,useAiAmazonWebFallback:true}
};
