const BUDGETS={
  test:{id:'test',label:'Test',maxImages:2,maxCandidates:12,maxSources:6,maxPages:3,maxEndpoints:6,maxMarketplaceReviews:20,maxAmazonQueries:1,maxAmazonPages:1,maxReferenceAiCalls:2,useAiCountEnrichment:false,useAiAmazonQueries:false,useAiAmazonWebFallback:false},
