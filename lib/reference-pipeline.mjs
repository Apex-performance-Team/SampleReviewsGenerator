const BUDGETS={
  test:{id:'test',label:'Test',maxImages:3,maxCandidates:24,maxSources:20,maxPages:3,maxEndpoints:6,maxMarketplaceReviews:20,maxAmazonQueries:4,maxAmazonPages:1,maxReferenceAiCalls:7,useAiCountEnrichment:true,useAiAmazonQueries:true,useAiAmazonWebFallback:false},
