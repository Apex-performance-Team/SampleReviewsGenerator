const BUDGETS={
  test:{id:'test',label:'Test',maxImages:3,maxCandidates:24,maxSources:20,maxPages:3,maxEndpoints:6,maxMarketplaceReviews:20,maxAmazonQueries:1,maxAmazonPages:1,maxReferenceAiCalls:5,useAiCountEnrichment:true,useAiAmazonQueries:false,useAiAmazonWebFallback:false},
  balanced:{id:'balanced',label:'Balanced',maxImages:3,maxCandidates:30,maxSources:20,maxPages:5,maxEndpoints:10,maxMarketplaceReviews:50,maxAmazonQueries:3,maxAmazonPages:2,maxReferenceAiCalls:8,useAiCountEnrichment:true,useAiAmazonQueries:true,useAiAmazonWebFallback:true},
