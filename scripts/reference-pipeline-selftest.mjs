...
assert.match(wrapper,/_lensProductUrl:stagedProductUrl/);
assert.match(wrapper,/signed_vercel_relay_with_native_fallback/);
assert.match(lensFallback,/body\?\._lensProductUrl\?\{\.\.\.body,productUrl:body\._lensProductUrl\}:body/);
